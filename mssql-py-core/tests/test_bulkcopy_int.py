...
"""Bulk copy tests for INT data type."""
import pytest
import mssql_py_core


@pytest.mark.integration
def test_cursor_bulkcopy_int_basic(client_context):
...
@pytest.mark.integration
def test_cursor_bulkcopy_int_auto_mapping(client_context):
...
@pytest.mark.integration
def test_cursor_bulkcopy_int_string_to_int_conversion(client_context):
...
@pytest.mark.integration
def test_cursor_bulkcopy_int_null_to_non_nullable_column(client_context):
...
@pytest.mark.integration
def test_cursor_bulkcopy_int_invalid_string_to_int_conversion(client_context):
    ...
    assert (
        error_raised
    ), "Expected a ValueError to be raised for invalid string-to-int conversion"
    assert (
...
@pytest.mark.integration
def test_cursor_bulkcopy_int_overflow_to_int_column(client_context):
